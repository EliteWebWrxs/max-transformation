...
export default function Home() {
  ...
  return (
    <div className="pt-16">
      {/* Hero Section */}
      <section className="relative bg-charcoal text-white py-32 lg:py-40 overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              time to rewrite the script and become your own biggest supporter.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Personalized coaching programs designed to meet you where you are
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "8-week deep dive into transforming your mindset",
                price: "$597",
              },
              {
