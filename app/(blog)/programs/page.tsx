            ...
            {programs.map((program, index) => (
              <div
                ...
                className={`relative bg-white rounded-2xl shadow-xl overflow-hidden ${
                  program.popular ? "ring-4 ring-teal transform scale-105" : ""
                }`}
              >
                {program.popular && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <div className="flex mb-4">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="text-sand fill-current" size={20} />
                ))}
              </div>
              <p className="text-gray-700 mb-6 italic">
                "The Mindset Mastery program completely changed how I see
                myself. I went from constant self-doubt to actually believing in
                my abilities. The live coaching calls were incredible!"
              </p>
              <div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <p className="text-gray-700 mb-6 italic">
                "The 1-on-1 coaching was exactly what I needed. Diane helped me
                identify and break through limiting beliefs I didn't even know I
